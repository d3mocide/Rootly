...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("kind", sa.Enum(name="plantkind", create_type=False), nullable=False),
        sa.Column("room", sa.String(), nullable=False, server_default=""),
        sa.Column("moisture", sa.Float(), nullable=False, server_default="0.5"),
        sa.Column("status", sa.Enum(name="plantstatus", create_type=False), nullable=False, server_default="thriving"),
