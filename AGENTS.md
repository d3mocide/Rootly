...
| API client | `frontend/src/api/` | `client.ts`, `auth.ts`, `plants.ts` |
| Screens | `frontend/src/screens/` | `mobile/` and `desktop/` sub-dirs |
| Components | `frontend/src/components/index.tsx` | Shared UI primitives |
| Tokens | `frontend/src/tokens.ts` | Design token object `T` — import from here, NOT components |
| Types | `frontend/src/types/plant.ts` | `Plant`, `PlantStatus`, `STATUS_META` |
...
- [ ] `frontend/src/screens/desktop/<Name>Desktop.tsx` — desktop view
