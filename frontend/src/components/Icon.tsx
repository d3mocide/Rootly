...
export function Icon({ name, size = 22, stroke = 1.9, color = 'currentColor', fill = 'none', style }: IconProps) {
  return (
    <svg
...
export function RootlyMark({ size = 28, color = 'currentColor', style }: MarkProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={{ display: 'block', ...style }}>
      <g stroke={color} strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round">
        <path d="M24 19 V30.5"/>
        <path d="M24 30.5 C19.5 34 16.5 38 15 43.5"/>
        <path d="M24 30.5 V44"/>
        <path d="M24 30.5 C28.5 34 31.5 38 33 43.5"/>
      </g>
      <path d="M24.2 21 C24.2 12.5 18.5 6 9.5 5 C8.6 14.2 14.8 20.6 24.2 21 Z" fill={color}/>
      <path d="M24.2 21 C24.2 13.5 29 8 36.6 7.2 C37.2 14.8 32.4 20.4 24.2 21 Z" fill={color} opacity="0.6"/>
    </svg>
  );
}
