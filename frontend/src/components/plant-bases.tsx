...
export const BASE_LABELS: Record<BaseKey, string> = {
  'fenestrated-tropical': 'Monstera',
  'single-trunk-tree':    'Fiddle-leaf',
  'upright-sword':        'Snake plant',
  'trailing-vine':        'Pothos',
  'rosette-succulent':    'Succulent',
  'strappy-arching':      'Spider plant',
  'palm-frond':           'Palm',
  'feathery-fern':        'Fern',
  'cactus':               'Cactus',
  'big-paddle':           'Bird of paradise',
  'patterned-broadleaf':  'Calathea',
  'paddle-succulent':     'Jade',
  'cactus-pad':           'Cactus pad',
  'beaded-strand':        'String of pearls',
};
