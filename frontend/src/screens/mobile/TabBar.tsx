...
export function TabBar({ active, onChange, onAdd }: TabBarProps) {
  return (
    <>
      {/* Reserves the nav zone in the flex column so content never hides under the pill */}
      <div style={{ flexShrink: 0, height: 'calc(72px + var(--sab))' }} />

      {/* Pill fixed to the viewport bottom — always anchored regardless of layout */}
      <div
